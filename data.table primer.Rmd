...
- If you looked at 'dt' in our previous slides after we added columns, you would not have seen the new columns
...
- You can also use `.SD` and `.SDcols` as described previouly
```{r}
